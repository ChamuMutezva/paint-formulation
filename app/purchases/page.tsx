...
async function getPurchases(): Promise<PurchaseWithDetails[]> {
  try {
      ...
      <header className="border-b border-border">
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center gap-4 mb-2">
            ...
            <div>
              <h1 className="text-3xl font-bold text-foreground">Purchase Records</h1>
              <p className="text-muted-foreground mt-1">View and manage customer paint purchases</p>
            </div>
          </div>
        </div>
      </header>
