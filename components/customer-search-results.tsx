...
export function CustomerSearchResults({
    results,
}: Readonly<CustomerSearchResultsProps>) {
...
function PurchaseCard({ purchase }: Readonly<{ purchase: any }>) {
    ...
    const totalQuantity = purchase.formulations.reduce(
        (sum: number, f: any) => sum + f.quantity,
        0
    );
            ...
            <CardContent>
                ...
                {expanded && (
                    <div className="space-y-3">
                                ...
                                (formulation: Formulation, idx: number) => (
                                    ...
                                    >
                                        ...
                                        <span className="font-medium">
                                            {formulation.quantity.toFixed(3)}{" "}
                                            {formulation.unit}
                                        </span>
                                    </div>
                                )
                        ...
                        <ShareFormulation
                            paintName={purchase.color_name}
                            productType={purchase.product_type}
                            size={purchase.size}
                            unit={purchase.unit}
                            formulations={purchase.formulations.map(
                                (f: any) => ({
