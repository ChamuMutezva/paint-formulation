        ...
        return (
            <div className="text-center py-12">
                ...
                <h3 className="text-lg font-semibold mb-2">
                    No paints in catalog
                </h3>
                <p className="text-muted-foreground mb-4">
                    Get started by adding your first paint color
                </p>
...
function PaintCard({
    ...
    const handleSizeChange = (newSize: string) => {
        ...
        const scaled = paint.formulations.map((f) =>
            scaleFormulation(f, size, paint.base_size)
        );
                ...
                <div className="flex items-start justify-between">
                    ...
                    <div className="flex gap-1">
                        ...
                        <Button
                            variant="ghost"
                            size="icon"
                            onClick={() => onDelete(paint.id, paint.color_name)}
                        >
            ...
            <CardContent className="flex-1">
                {paint.formulations.length === 0 ? (
                    <p className="text-sm text-muted-foreground italic">
                        No formulation added yet
                    </p>
                ) : (
                    <div className="space-y-4">
                        <div className="space-y-2">
                            <Label
                                htmlFor={`size-${paint.id}`}
                                className="text-sm"
                            >
                                Calculate for size:
                            </Label>
                        ...
                        {expanded && (
                            <div className="space-y-3">
                                ...
                                <ShareFormulation
                                    ...
                                    size={Number.parseFloat(customSize)}
